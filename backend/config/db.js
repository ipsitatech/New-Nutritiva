  ...
  try {
    ...
    if (prodCount.cnt === 0) {
      const initialProducts = [
        ...
        { id: 7, name: 'Pumpkin Seeds', weight: 250, price: 249, originalPrice: 299, category_id: 2, image: 'pumpkin_seeds' },
        { id: 8, name: 'Flax Seeds', weight: 250, price: 129, originalPrice: 169, category_id: 2, image: 'flax_seeds' },
        { id: 9, name: 'Roasted Makhana', weight: 150, price: 180, originalPrice: 240, category_id: 3, image: 'makhana' },
        { id: 10, name: 'Baked Beetroot Chips', weight: 100, price: 120, originalPrice: 150, category_id: 3, image: 'beetroot_chips' },
        { id: 11, name: 'Pink Himalayan Salt', weight: 1000, price: 139, originalPrice: 199, category_id: 4, image: 'himalayan_salt' },
        { id: 12, name: 'Organic Quinoa', weight: 500, price: 299, originalPrice: 399, category_id: 4, image: 'quinoa' },
        { id: 13, name: 'Organic Turmeric Powder', weight: 250, price: 99, originalPrice: 149, category_id: 5, image: 'turmeric' },
        { id: 14, name: 'Whole Black Pepper', weight: 200, price: 189, originalPrice: 249, category_id: 5, image: 'pepper' },
