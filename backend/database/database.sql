...
(7, 2, 1, 'Pumpkin Seeds', 'SKU-NUTR-PUMPKIN-SEEDS', 'Premium quality organic Pumpkin Seeds loaded with nutrients.', 249.00, 250, 150, 'seeds', 1),
(8, 2, 1, 'Flax Seeds', 'SKU-NUTR-FLAX-SEEDS', 'Premium quality organic Flax Seeds loaded with nutrients.', 129.00, 250, 150, 'seeds', 1),
(9, 3, 1, 'Roasted Makhana', 'SKU-NUTR-ROASTED-MAKHANA', 'Premium quality organic Roasted Makhana loaded with nutrients.', 180.00, 150, 150, 'cashews', 1),
(10, 3, 1, 'Baked Beetroot Chips', 'SKU-NUTR-BAKED-BEETROOT-CHIPS', 'Premium quality organic Baked Beetroot Chips loaded with nutrients.', 120.00, 100, 150, 'seeds', 1),
(11, 4, 1, 'Pink Himalayan Salt', 'SKU-NUTR-PINK-HIMALAYAN-SALT', 'Premium quality organic Pink Himalayan Salt loaded with nutrients.', 139.00, 1000, 150, 'spices', 1),
