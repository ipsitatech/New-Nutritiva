...
const DoughnutChart = () => {
  // Conforming to: Protein Intake (green), Healthy Snacks (orange), Superfoods (purple), Organic Products (blue)
  const goals = [
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-xs h-full flex flex-col">
      <h3 className="font-semibold text-slate-800 text-lg mb-4">Nutrition Goals</h3>
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        {/* Legend Grid */}
        <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 w-full text-xs mt-2">
          {goals.map((g, idx) => (
