    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-[32px] w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8 max-h-[60vh] overflow-y-auto text-gray-600 space-y-4">
          ...
          <p>
            By registering on Nutritva, you agree to provide accurate
            information and abide by our quality standards. We reserve the right
            to verify all business and personal details provided during
            registration.
          </p>
          ...
          <p>
            ...
            We never share your sensitive financial information with third
            parties without your explicit consent.
          </p>
          <p className="font-bold text-gray-900">3. Quality Standards</p>
          <p>
            As a Nutritva partner or user, you commit to maintaining the highest
            standards of food safety and premium quality as defined in our
            seller handbook.
          </p>
          <p>
            ... and more detailed legal terms regarding commissions, refunds,
            and usage policies.
          </p>
        </div>
